...
class UI():
    ...
    def getAll(self):
        ...
        Label(root,bg="#2f343f",fg="green",font=("NotoSans",font_size), text="Version: 10.3").grid(row=11, column=4, columnspan=2, sticky="s")
        Label(root,bg="#2f343f",fg="green",font=("NotoSans",font_size), text="Data: 08/12/2025").grid(row=12, column=4, columnspan=2, sticky="n")
